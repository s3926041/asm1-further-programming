            ...
            lines.forEach(line -> {
                ...
                if (fields[0].contains("product")) {
                    ...
                    if (fields[0].equals("physicalproduct")) {
                        ...
                        newProduct = new PhysicalProduct(name, description, quantity, price, weight, taxType, canBeGift);
                    } else {
                        newProduct = new DigitalProduct(name, description, quantity, price, taxType, canBeGift);
                    }
                }
                // coupon check
